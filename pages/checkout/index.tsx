                    ...
                    <div className="md:w-96 p-3 flex flex-col gap-3 overflow-y-scroll flex-grow basis-40">
                            {
                                props.cartComponents && props.cartComponents.map((component : CartComponent) => (
                                    <div key={component.componentId} className="flex">
                                        <Image src={process.env.NODE_ENV === 'development' ? `/${component.Component.ComponentPicture[0].Picture.name}` : 'https://njkmajcfosaflafhlphb.supabase.co/storage/v1/object/public/pictures/' + component.Component.ComponentPicture[0].Picture.name} width="100" height="100" alt={component.Component.name}></Image>
