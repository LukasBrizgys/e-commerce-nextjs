    ...
    return (
        ...
        <Menu as="div" className="relative inline-block text-left">
          ...
          <Menu.Items className="absolute left-0 sm:left-auto sm:right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none">
            ...
            <div className={openCart ? "relative cursor-pointer bg-teal-100 bg-opacity-40 p-5 rounded-full" : "relative cursor-pointer p-5 rounded-full"} onClick={() => setOpenCart(!openCart)}>
                <span className="absolute left-8 top-2 bg-red-600 text-white px-2 py-0.5 rounded-full text-sm">0</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                    </svg>
                    <Cart className="relative" open={openCart} setOpen={setOpenCart}/>
            </div> 
