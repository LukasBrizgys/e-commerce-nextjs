        ...
        <div className="mt-5 overflow-hidden rounded-xl pt-4 bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl flex-initial basis-72">
            <div className="p-4">
                <div className="max-w-sm">
                    <Image src={`https://njkmajcfosaflafhlphb.supabase.co/storage/v1/object/public/pictures/${component.ComponentPicture[0].Picture.name}`} alt={component.name} width="320" height="320"></Image>
                </div>
                <div className="h-28">
