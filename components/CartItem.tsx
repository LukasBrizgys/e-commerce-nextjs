...
const CartItem = ({ component, mobile } : ICartItem) => {
    ...
    return (
        ...
        <div className={mobile ? "flex items-center justify-between gap-2 border-y py-4 relative w-full" : "flex items-center justify-between gap-2 h-28 py-4 px-2 border-y relative"}>
            ...
            <div className="block">
                <Image  src={`https://njkmajcfosaflafhlphb.supabase.co/storage/v1/object/public/pictures/${component.Component.ComponentPicture[0].Picture.name}`} width="150" height="150" alt={component.Component.name}></Image>
            </div>
